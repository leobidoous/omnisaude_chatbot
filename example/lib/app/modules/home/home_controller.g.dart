...
mixin _$HomeController on _HomeControllerBase, Store {
  final _$botUsernameAtom = Atom(name: '_HomeControllerBase.botUsername');
  ...
  final _$botTypingAtom = Atom(name: '_HomeControllerBase.botTyping');
  ...
  final _$_onScrollListToBottomAsyncAction =
      AsyncAction('_HomeControllerBase._onScrollListToBottom');
  ...
  final _$_onChangeChatGlobalConfigsAsyncAction =
      AsyncAction('_HomeControllerBase._onChangeChatGlobalConfigs');
